        ...
        for epoch in range(1, num_epochs + 1):
            ...
            if disp_interval is not None and epoch % disp_interval == 0:
                ...
                if epoch_loss < minLoss:
                    torch.save(self.state_dict(), 'Wavenet_{:d}_{:.4f}.pt'.format(epoch, epoch_loss))
                print('Epoch {}/{}: lr: {:.4f}, {} Loss: {:.4f}'.format(
                    epoch, num_epochs, self.optimizer.param_groups[0]['lr'], 
                    phase, epoch_loss))
